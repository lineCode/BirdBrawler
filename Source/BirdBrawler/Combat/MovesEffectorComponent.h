...
public:
	...
	void EnableHitbox(const UHitboxDataAsset* HitboxDataAsset, bool ForceOpponentFacing, float DamagePercent, bool IgnoreKnockbackMultiplier, const UWorld* World,
	                  AActor* Owner, const FVector& Location, uint32 Id);

	void EnableHitbox(const UHitboxDataAsset* HitboxDataAsset, bool ForceOpponentFacing, float DamagePercent, bool IgnoreKnockbackMultiplier, const UWorld* World,
	                  AActor* Owner, USkeletalMeshComponent* SkeletalMesh, const FName& SocketToFollow, uint32 Id);
